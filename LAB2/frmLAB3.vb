...
Public Class frmLAB3
    ...
    'Program description: The user will input 7 values in the input text box, one for each day of the week(7), for three employees. 
    'Inputs are validated and must be a whole number, numeric and between 0 - 1000 (inclusive).
    'Each valid input will be displayed vertically inside the corresponding employee output textbox.
    'When 7 valid inputs are entered, the average will be displayed for that employee. This process is repeated for three employees.
    'The overall average will then be diplayed in the output label, at this point the user can only reset the form or exit the program.
